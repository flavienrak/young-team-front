...
export default function RegisterComponent() {
  const [showRegister, setShowRegister] = React.useState<UserType | null>(null);
          ...
          <div className="max-w-md flex flex-col gap-8">
            {showRegister ? (
              <>
                ...
                <RegisterForm type={showRegister} />
              </>
            ) : (
              <>
                <Card
                  onClick={() => setShowRegister('person')}
                ...
                <Card
                  onClick={() => setShowRegister('organization')}
                  className="cursor-pointer hover:text-[var(--secondary-color)]"
                >
                  <label
